          ...
          tabs={[
            // just a simple text feedback
            {
              ...
              content: (<div className="mt-4">
                <p className="mb-2">
                  Teach the model what was wrong with the generated SQL query. This will help improve the model.
                </p>
                <textarea
                ...
                <button
                  ...
                  onClick={() => {
                    const feedbackText = document.getElementById(`${question}-feedback-text`).value;
            ...
            // a section to provide a new SQL query
            {
              ...
              <div className="mt-4">
                <p className="mb-2">
                  Optionally, please provide the correct SQL query for answering this question. As a reminder, the question was: <span className="font-mono font-semibold">{question}</span>
                  <br/>
                </p>
                <p className="mb-2">
