...
const SQLFeedback = ({ question, sql, apiEndpoint, token, keyName }) => {
  ...
  return (
    <div className="h-10 mt-2">
      ...
      <Modal
        ...
        rootClassNames="dark:bg-gray-800 bg-white z-50"
      >
        {/* first, a section to provide simple text feedback */}
        <Tabs
          disableSingleSelect={true}
          defaultSelected="Provide Correct SQL"
          tabs={[
            // a section to provide a new SQL query
            {
              ...
              content: (
                <div className="mt-4 dark:text-gray-200">
                  <p className="mb-2">
                    Please provide the correct SQL query for answering this
                    question. As a reminder, the question was:{" "}
                    <span className="font-mono font-semibold dark:text-blue-300">
                      {question}
                    </span>
                    <br />
                  </p>
