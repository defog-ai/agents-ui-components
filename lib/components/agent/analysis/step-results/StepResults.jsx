              ...
              <>
                ...
                <>
                  <p className="mt-8 mb-2 text-sm font-mono">
                    <span className="font-bold">Reference Queries</span>: amongst the golden queries you uploaded, these queries were selected as reference queries. If there are no related golden queries, then what you see below might be irrelevant
                  </p>
                  <Tabs
                    ...
                    tabs={step.reference_queries.map((query, i) => (
                      {
                        name: `Question ${i + 1}`,
                        content: (
                          <pre key={i} className="text-sm text-gray-600 p-2 bg-gray-100 rounded mb-4 whitespace-break-spaces">
...

                {
                  ...
                  <>
                    ...
                    <pre className="text-sm text-gray-600 p-2 bg-gray-100 rounded whitespace-break-spaces max-h-64 overflow-auto">
                      {step.instructions_used}
                    </pre>
                  </>
                }
