 ...
 * @property {object} config.extraTools - if this analysis uses any extra tools. Used in the add tool UI.
 * @property {object} config.plannerPromptSuffix - suffix for the planner model's prompt. Used in the add tool UI.
 */
    ...
    try {
      ...
      while (!done) {
        const body = {
          ...
          planner_prompt_suffix: plannerPromptSuffix,
        };
