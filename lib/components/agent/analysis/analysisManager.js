 ...
 * @property {function} getAnalysisBiusy - Returns the analysis busy state
 ...
 * @property {function} addEventListeners - Adds event listeners
 * @property {function} removeEventListeners - Removes event listeners
 * @property {function} submit - Submits a query
 * @property {function} initiateReRun - Initiates a rerun
 * @property {function} setMainSocket - Sets the main socket
 * @property {function} setReRunSocket - Sets the rerun socket
 * @property {function} deleteSteps - Deletes steps
 * @property {function} destroy - Destroys the analysis manager
 * @property {function} setOnReRunDataCallback - Sets the rerun data callback
...
function AnalysisManager({
  ...
  function initiateReRun(stepId, preRunActions) {
  ...
  async function onReRunSocketMessage(event) {
    ...
    try {
      ...
      const idx = newSteps.findIndex((d) => d.id === response.id);
