    ...
    Plot.lineY(
      ...
      Plot.groupX(
        { y: aggregateFunction },
        {
          ...
          stroke: options.stroke || "label",
          facetX: options.facet,
          strokeWidth: options.lineOptions.strokeWidth || options.lineWidth,
