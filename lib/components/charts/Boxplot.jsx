 ...
 * @property {boolean} facet - Whether to facet the boxplots. Default is false.
 * @property {string} facetCol - Column name to use for facetting
 * @property {string} color - Color of the boxplot. Default is "#000000".
 * @property {number} opacity - Opacity of the points. Default is 0.4.
 ...
 * @property {number} padding - Padding between boxplots of each x category. Default is 0.05.
 *
